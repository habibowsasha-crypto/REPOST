...
def test_scheduled_real_dialog_ignores_first_dm_peerflood_cooldown(app_env, monkeypatch):
    ...
    assert client.sent == ["Сорян, не хотел навязываться. Просто поделился."]


def test_incoming_dialog_ignores_first_dm_peerflood_cooldown(app_env, monkeypatch):

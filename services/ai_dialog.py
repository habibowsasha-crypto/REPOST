...
def _branch_instruction(branch: str, pitch: str) -> str:
    angle = {
        "self": "Юзер сам торгует. Коротко отзеркаль и мягко мостик к разборам/каналу.",
        "signals": "Юзер по сигналам. Отзеркаль и мостик: смотришь чужие разборы без оплаты.",
        "newbie": "Новичок/просит совет. Без менторства, мягко: есть пачка разборов в одном месте.",
        "other": "Ответ общий. Коротко зачем написал + мостик к каналу.",
